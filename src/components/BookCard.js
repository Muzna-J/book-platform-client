...
function BookCard({book}) {
    ...
    return (
            ...
            <Link to={`/book/${volumeId}`} className="bg-custom-crimson 500 hover:bg-custom-beige 700 text-white font-mono font-bold py-2 px-4 rounded-b-lg block text-center">
                    View More
    </Link>  
            </div>
        )
